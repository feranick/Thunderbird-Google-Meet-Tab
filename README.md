# Google Meet Tab
Unofficial Google Meet add-on for Thunderbird, it adds a button in Spaces that opens a Google Meet tab in Thunderbird.
The [home page](https://addons.mozilla.org/thunderbird/addon/thundermeet/) of the extension contains some pictures and reviews.

#### Installing 
A new Google Meet icon should appear in the Spaces Toolbar of Thunderbird. Click to open.
